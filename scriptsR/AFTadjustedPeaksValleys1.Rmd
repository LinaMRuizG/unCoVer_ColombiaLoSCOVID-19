...
data$PeaksValleys1<- as.factor(data$PeaksValleys1)
```
...
flexsurvreg(aft  ~  PeaksValleys1 , data=data_H_RD,
                         dist = "lnorm")
```
...
```{r}
aft<- with(data_H_ICUf,  Surv (data_H_ICUf$times,data_H_ICUf$outcome==1))
flexsurvreg(aft  ~ PeaksValleys1 , data=data_H_ICUf,
                         dist = "lnorm")
```
...
```{r}
aft<- with(data_ICUf_RD,  Surv (data_ICUf_RD$times,data_ICUf_RD$outcome==1))
flexsurvreg(aft  ~ PeaksValleys1, data=data_ICUf_RD, dist = "lnorm")
```
...
```{r}
aft<- with(data_BP3,  Surv (data_BP3$times,data_BP3$outcome==1))
flexsurvreg(aft  ~ PeaksValleys1, data=data_BP3, dist = "lnorm")
```
...
```{r}
aft<- with(data_ICU_RD,  Surv (data_ICU_RD$times,data_ICU_RD$outcome==1))
flexsurvreg(aft  ~ PeaksValleys1, data=data_ICU_RD, dist = "lnorm")
```
...
```{r}
aft<- with(data_ICU_Hf,  Surv (data_ICU_Hf$times,data_ICU_Hf$outcome==1))
flexsurvreg(aft  ~ PeaksValleys1, data=data_ICU_Hf, dist = "lnorm")
```
...
```{r}
aft<- with(data_Hf_RD,  Surv (data_Hf_RD$times,data_Hf_RD$outcome==1))
flexsurvreg(aft  ~ PeaksValleys1, data=data_Hf_RD, dist = "lnorm")
```
...
```{r}
aft<- with(data_BP4,  Surv (data_BP4$times,data_BP4$outcome==1))
flexsurvreg(aft  ~ PeaksValleys1, data=data_BP4, dist = "lnorm")
```
