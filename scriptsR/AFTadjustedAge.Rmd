...
gmma.aft_H_RD <- flexsurvreg(aft_H_RD  ~  AgeG, data=data_H_RD,
                         dist = "gamma")
exp.aft_H_RD <- flexsurvreg(aft_H_RD  ~ AgeG, data=data_H_RD,
                         dist = "exp")
llogis.aft_H_RD <- flexsurvreg(aft_H_RD  ~ AgeG, data=data_H_RD,
                         dist = "llogis")
lnorm.aft_H_RD <- flexsurvreg(aft_H_RD  ~  AgeG , data=data_H_RD,
                         dist = "lnorm")
weibull.aft_H_RD <- flexsurvreg(aft_H_RD  ~ AgeG, data=data_H_RD,
                         dist = "weibull")
...
flexsurvreg(aft_H_RD  ~ AgeG + sdlog(AgeG), data=data_H_RD,
                         dist = "lnorm")
```
...
```{r}
flexsurvreg(aft  ~ AgeG , data=data_H_ICUf, dist = "lnorm")
```
...
gmma.aft <- flexsurvreg(aft ~ AgeG, data=data_ICUf_RD,
                         dist = "gamma")
exp.aft <- flexsurvreg(aft  ~ AgeG, data=data_ICUf_RD,
                         dist = "exp")
llogis.aft <- flexsurvreg(aft  ~ AgeG , data=data_ICUf_RD,
                         dist = "llogis")
lnorm.aft <- flexsurvreg(aft  ~ AgeG , data=data_ICUf_RD,
                         dist = "lnorm")
weibull.aft <- flexsurvreg(aft  ~ AgeG , data=data_ICUf_RD,
                         dist = "weibull")
...
```{r}
flexsurvreg(aft  ~ AgeG , data=data_ICUf_RD, dist = "lnorm")
```
...
```{r}
flexsurvreg(aft  ~ AgeG + sdlog(AgeG), data=data_BP3, dist = "lnorm")
flexsurvreg(aft  ~ AgeG, data=data_BP3, dist = "lnorm")
```
...
flexsurvreg(aft  ~ AgeG , data=data_ICU_RD, dist = "lnorm")
```
...
```{r}
flexsurvreg(aft  ~ AgeG + sdlog(AgeG), data=data_ICU_Hf, dist = "lnorm")
flexsurvreg(aft  ~ AgeG , data=data_ICU_Hf, dist = "lnorm")
```
...
```{r}
flexsurvreg(aft  ~ AgeG + sdlog(AgeG), data=data_Hf_RD, dist = "lnorm")
flexsurvreg(aft  ~ AgeG , data=data_Hf_RD, dist = "lnorm")
```
...
flexsurvreg(aft  ~ AgeG + shape(AgeG), data=data_BP4, dist = "weibull")
flexsurvreg(aft  ~ AgeG , data=data_BP4, dist = "lnorm")
```
